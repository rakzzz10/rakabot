...
/////////////////
const BotName = 'RAKA BOT☄'; 
const instagram = 'https://instagram.com/raka_snjya10'; 
const telegram = 'https://t.me/raka_snjya'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'gapunya channel YouTube';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@raka_snjya10')
